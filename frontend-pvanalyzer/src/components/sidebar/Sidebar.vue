<template>
  <div class="sidebar" :style="{width: sidebarWidth}">
    ...
    <SidebarLink to='/pv-installation' icon="fa-solid fa-solar-panel">Moja instalacja</SidebarLink>
    <SidebarLink to='/profile' icon="fas fa-user">Jan Rapowanie</SidebarLink>
